...
//    public List<String> generate(List<PlaceKakaoSearchApiResultDTO> places) {
...
//    }
//
//    public List<String> generateForSinglePlace(PlaceKakaoSearchApiResultDTO place) {
//        List<PlaceKakaoSearchApiDTO> items = place.getItems();
//        if (!items.isEmpty()) {
...
//    }
//
//    private static void generateForPlace(List<PlaceKakaoSearchApiResultDTO> places, Map<String, Integer> provinces, Map<String, Integer> cities, Map<String, Integer> districts) {
//        for (PlaceKakaoSearchApiResultDTO place : places) {
//            List<PlaceKakaoSearchApiDTO> item = place.getItems();
