...
VALUES (1, '대학교');
INSERT INTO place (name, coordinates, thumbnail, address, road_address, description)
VALUES ('강남대학교', ST_SetSRID(ST_MakePoint(37.27574, 127.13249), 4326), null, '구갈동 111 강남대학교', '경기 용인시 기흥구 강남로 40 강남대학교',
        null);
